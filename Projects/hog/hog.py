...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        cur_score, new_high = score - last_score, 0
        if cur_score > running_high:
            print(cur_score, "point(s)!", "That's a record gain for Player", 
                f"{who}!")
            new_high = cur_score
        else:
            new_high = running_high
        return announce_highest(who, score, new_high)
    return say
    # END PROBLEM 7
